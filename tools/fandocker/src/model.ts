...
export type Boot = { document: Catalog; files: string[]; folder: string; dataDir: string; context: string; dates: Record<string, { modified: number; created: number }>; folderMissing: boolean }
